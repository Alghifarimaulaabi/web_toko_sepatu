...
export type GetNotifikasiAggregateType<T extends NotifikasiAggregateArgs> = {
    [P in keyof T & keyof AggregateNotifikasi]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateNotifikasi[P]> : Prisma.GetScalarType<T[P], AggregateNotifikasi[P]>;
};
...
type GetNotifikasiGroupByPayload<T extends NotifikasiGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<NotifikasiGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof NotifikasiGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], NotifikasiGroupByOutputType[P]> : Prisma.GetScalarType<T[P], NotifikasiGroupByOutputType[P]>;
}>>;
export type NotifikasiWhereInput = {
    ...
    type?: Prisma.StringFilter<"Notifikasi"> | string;
    reference_id?: Prisma.IntNullableFilter<"Notifikasi"> | number | null;
...
export type NotifikasiScalarWhereWithAggregatesInput = {
    ...
    type?: Prisma.StringWithAggregatesFilter<"Notifikasi"> | string;
    reference_id?: Prisma.IntNullableWithAggregatesFilter<"Notifikasi"> | number | null;
...
export type NotifikasiOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "judul" | "pesan" | "is_read" | "type" | "reference_id" | "created_at", ExtArgs["result"]["notifikasi"]>;
...
export type NotifikasiCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<NotifikasiFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface NotifikasiDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['Notifikasi'];
        meta: {
            name: 'Notifikasi';
        };
    };
     ...
     *
     */
    createManyAndReturn<T extends NotifikasiCreateManyAndReturnArgs>(args?: Prisma.SelectSubset<T, NotifikasiCreateManyAndReturnArgs<ExtArgs>>): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$NotifikasiPayload<ExtArgs>, T, "createManyAndReturn", GlobalOmitOptions>>;
    /**
     * Delete a Notifikasi.
     ...
     *
     */
    updateManyAndReturn<T extends NotifikasiUpdateManyAndReturnArgs>(args: Prisma.SelectSubset<T, NotifikasiUpdateManyAndReturnArgs<ExtArgs>>): Prisma.PrismaPromise<runtime.Types.Result.GetResult<Prisma.$NotifikasiPayload<ExtArgs>, T, "updateManyAndReturn", GlobalOmitOptions>>;
    /**
     ...
     * })
    **/
    count<T extends NotifikasiCountArgs>(args?: Prisma.Subset<T, NotifikasiCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], NotifikasiCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends NotifikasiGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, NotifikasiGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetNotifikasiGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
export interface NotifikasiFieldRefs {
    ...
    readonly type: Prisma.FieldRef<"Notifikasi", 'String'>;
    readonly reference_id: Prisma.FieldRef<"Notifikasi", 'Int'>;
 ...
 */
export type NotifikasiCreateManyAndReturnArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Notifikasi
     */
    select?: Prisma.NotifikasiSelectCreateManyAndReturn<ExtArgs> | null;
    /**
     * Omit specific fields from the Notifikasi
     */
    omit?: Prisma.NotifikasiOmit<ExtArgs> | null;
 ...
 */
export type NotifikasiUpdateManyAndReturnArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Notifikasi
     */
    select?: Prisma.NotifikasiSelectUpdateManyAndReturn<ExtArgs> | null;
    /**
     * Omit specific fields from the Notifikasi
     */
    omit?: Prisma.NotifikasiOmit<ExtArgs> | null;
