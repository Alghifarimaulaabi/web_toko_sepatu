...
export const updateProfile = async (req: AuthRequest, res: Response): Promise<void> => {
  try {
    ...
    if (alamat !== undefined) updatedData.alamat = alamat;
    if (kota !== undefined) updatedData.kota = kota;
    if (provinsi !== undefined) updatedData.provinsi = provinsi;
    if (kode_pos !== undefined) updatedData.kode_pos = kode_pos;
